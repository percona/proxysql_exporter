...
var (
	...
	versionF       = flag.Bool("version", false, "Print version information.")
	...
	mysqlStatusF         = flag.Bool("collect.mysql_status", true, "Collect from SHOW MYSQL STATUS.")
...
func main() {
	...
	log.Infof("Starting proxysql_exporter %s for %s", Version, dsn)
	...
	if *sslCertFileF != "" && *sslKeyFileF == "" || *sslCertFileF == "" && *sslKeyFileF != "" {
